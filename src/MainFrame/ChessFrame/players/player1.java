...
/**
  * player1, Creates a new instance of player1
  */
...
public class player1 {
  ...
  public player1() {
    ...
    WC1 = new Castle(
        "src" + fileSeparator + "Icons" + fileSeparator + "Player1Icons" + fileSeparator + "wr.gif",
        8, 8);
    WC2 = new Castle(
        "src" + fileSeparator + "Icons" + fileSeparator + "Player1Icons" + fileSeparator + "wr.gif",
        1, 8);
    WH1 = new Horse(
        "src" + fileSeparator + "Icons" + fileSeparator + "Player1Icons" + fileSeparator + "wn.gif",
        2, 8);
    WH2 = new Horse(
        "src" + fileSeparator + "Icons" + fileSeparator + "Player1Icons" + fileSeparator + "wn.gif",
        7, 8);
    WE1 = new Elephent(
        "src" + fileSeparator + "Icons" + fileSeparator + "Player1Icons" + fileSeparator + "wb.gif",
        3, 8);
    WE2 = new Elephent(
        "src" + fileSeparator + "Icons" + fileSeparator + "Player1Icons" + fileSeparator + "wb.gif",
        6, 8);
    WQ = new Queen(
        "src" + fileSeparator + "Icons" + fileSeparator + "Player1Icons" + fileSeparator + "wq.gif",
        4, 8);
    WK = new king(
        "src" + fileSeparator + "Icons" + fileSeparator + "Player1Icons" + fileSeparator + "wk.gif",
        5, 8);
    int j = 1;
    for (int i = 0; i <= 7; i++, j++) {
      WS[i] = new Solider( "src" + fileSeparator + "Icons" + fileSeparator + "Player1Icons"
   ...
   * @param i
   * @param P
   * @return i.setSeenbychecking( P, "white");
   */
   ...
   * @param i
   * @return i.PieceInMYway( newP.x, newP.y, postionFromOthers);
   */
   ...
   * @param p2
   * @param i
   * @return i.checkKing( p1.x, p1.y, p2);
   */
   ...
   * @param newP
   * @param enemy
   * @return (newP.x == samePostion.x && newP.y == samePostion.y) ? true : false
   */
  ...
  public boolean Check_The_Way_to_Postion(player2 enemy, Point newP) {
    ...
    for (int i = 1; i <= 32; i++) {
      ...
      {
        if (i < 17)
          flag = checktheWay( newP, enemy.returnPostion( i), inHand);// Means there is somting in
                                                                     // the Way so can't move
        else {
