...
/**
 * player2 Creates a new instance of player2
 */
/**
  *
  */
public class player2 implements Enumeration<Object> {
  public Castle BC1;
  public Castle BC2;
  public Horse BH1;
  public Horse BH2;
  ...
  public player2() {
    ...
    BC1 = new Castle(
        "src" + fileSeparator + "Icons" + fileSeparator + "Player2Icons" + fileSeparator + "br.gif",
        1, 1);
    BC2 = new Castle(
        "src" + fileSeparator + "Icons" + fileSeparator + "Player2Icons" + fileSeparator + "br.gif",
        8, 1);
    BH1 = new Horse(
        "src" + fileSeparator + "Icons" + fileSeparator + "Player2Icons" + fileSeparator + "bn.gif",
        2, 1);
    BH2 = new Horse(
        "src" + fileSeparator + "Icons" + fileSeparator + "Player2Icons" + fileSeparator + "bn.gif",
        7, 1);
    BE1 = new Elephent(
        "src" + fileSeparator + "Icons" + fileSeparator + "Player2Icons" + fileSeparator + "bb.gif",
        3, 1);
    BE2 = new Elephent(
        "src" + fileSeparator + "Icons" + fileSeparator + "Player2Icons" + fileSeparator + "bb.gif",
        6, 1);
    BQ = new Queen(
        "src" + fileSeparator + "Icons" + fileSeparator + "Player2Icons" + fileSeparator + "bq.gif",
        4, 1);
    BK = new king(
        "src" + fileSeparator + "Icons" + fileSeparator + "Player2Icons" + fileSeparator + "bk.gif",
        5, 1);
    int j = 1;
    for (int i = 0; i <= 7; i++, j++) {
      BS[i] = new Solider( "src" + fileSeparator + "Icons" + fileSeparator + "Player2Icons"
  ...
  public Point returnPostion(int i) {
    switch (i) {
      case 1:
        return BC1.returnPostion();
      case 2:
        return BC2.returnPostion();
      case 3:
        return BH1.returnPostion();
      case 4:
        return BH2.returnPostion();
      case 5:
        return BE1.returnPostion();
      case 6:
        return BE2.returnPostion();
      case 7:
      ...
      case 10:
        return BS[1].returnPostion();
      case 11:
        return BS[2].returnPostion();
      case 12:
        return BS[3].returnPostion();
      case 13:
        return BS[4].returnPostion();
      case 14:
        return BS[5].returnPostion();
      case 15:
  ...
  public Point returnOldPostion(int i) {
    switch (i) {
      case 1:
        return BC1.returnOld();
      case 2:
        return BC2.returnOld();
      case 3:
        return BH1.returnOld();
      case 4:
        return BH2.returnOld();
      case 5:
        return BE1.returnOld();
      case 6:
        return BE2.returnOld();
      case 7:
        return BQ.returnOld();
      case 8:
        return BK.returnOld();
      ...
      case 10:
        return BS[1].returnOld();
      case 11:
        return BS[2].returnOld();
      case 12:
        return BS[3].returnOld();
      case 13:
        return BS[4].returnOld();
      case 14:
        return BS[5].returnOld();
      case 15:
  ...
  public Image returnIconImage(int i) {
    switch (i) {
      case 1:
        return BC1.returnPieceImage();
      case 2:
        return BC2.returnPieceImage();
      case 3:
        return BH1.returnPieceImage();
      case 4:
        return BH2.returnPieceImage();
      case 5:
        return BE1.returnPieceImage();
      case 6:
        return BE2.returnPieceImage();
      case 7:
        return BQ.returnPieceImage();
      case 8:
        return BK.returnPieceImage();
      case 9:
        return BS[0].returnPieceImage();
      case 10:
        return BS[1].returnPieceImage();
      case 11:
        return BS[2].returnPieceImage();
      case 12:
        return BS[3].returnPieceImage();
      case 13:
        return BS[4].returnPieceImage();
      case 14:
        return BS[5].returnPieceImage();
      case 15:
   ...
   * @param newP
   * @param i
   * @return i.Canmove( newP.x, newP.y)
   */
   ...
   * returnsoliderSeen
   * @param i
   * @return i.returnMyseen();
   */
  public boolean returnsoliderSeen(int i) {
    switch (i) {     
      case 9:
        return BS[0].returnMyseen();
      case 10:
        return BS[1].returnMyseen();
      case 11:
        return BS[2].returnMyseen();
      case 12:
        return BS[3].returnMyseen();
      case 13:
        return BS[4].returnMyseen();
      case 14:
        return BS[5].returnMyseen();
      case 15:
  ...
  public boolean checktheWay(Point newP, Point postionFromOthers, int i) {
    switch (i) {
      ...
      case 2:
        ...
        //TODO: why is there no case 3,4, or 8?
      case 5:
  ...
  public boolean CanMove(int x, int y) {
    return true;  // TODO: why is this always true?
  }
  ...
  /**
   * Get_Pice_already_there_from_enemy
   * 
   * @param newP
   * @param enemy
   * @return (newP.x == samePostion.x && newP.y == samePostion.y) ? i : -1
   */
  ...
  /**
   * Tell_me_About_last_move
   * 
   * @return inHand.Tell_me()
   */
